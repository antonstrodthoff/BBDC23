...
def plotColumn(fileName="", plotColumn=2, separator=";", dropFirstNValues=1, dateFormat="%d.%m.%Y", label="", window=0, alpha=0.3):
...
#plotColumn(fileName="task_student/bbdc_2023_AWI_data_develop_student.csv", plotColumn=2, separator=";", dropFirstNValues=1, label="t_secci", window=50)
plotColumn(fileName="task_student/bbdc_2023_AWI_data_develop_student.csv", plotColumn=3, separator=";", dropFirstNValues=1, label="t_temp", window=50)
#plotColumn(fileName="task_student/bbdc_2023_AWI_data_develop_student.csv", plotColumn=4, separator=";", dropFirstNValues=1, label="t_salinity", window=50)
#plotColumn(fileName="task_student/bbdc_2023_AWI_data_develop_student.csv", plotColumn=5, separator=";", dropFirstNValues=1, label="t_no2", window=50)
...
#plotColumn(fileName="task_student/bbdc_2023_AWI_data_develop_student.csv", plotColumn=7, separator=";", dropFirstNValues=1, label="t_nox", window=50)
